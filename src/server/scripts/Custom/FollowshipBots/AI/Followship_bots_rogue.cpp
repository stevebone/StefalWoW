...
std::vector<FSBSpellDefinition> RogueSpellsTable =
{
    ...
    { SPELL_ROGUE_BLIND,                    FSBSpellType::Damage,   0.f,        0.f,            100.f,           15.f,          false,      120000,         FSB_RoleMask::FSB_ROLEMASK_ANY },

    { SPELL_ROGUE_KICK,                     FSBSpellType::Damage,   0.f,        0.f,            100.f,           2.f,           false,      15000,          FSB_RoleMask::FSB_ROLEMASK_ANY },
    { SPELL_ROGUE_CHEAP_SHOT,               FSBSpellType::Damage,   0.f,        0.f,            100.f,           2.f,           false,      12000,          FSB_RoleMask::FSB_ROLEMASK_ANY },
    { SPELL_ROGUE_AMBUSH,                   FSBSpellType::Damage,   0.f,        0.f,            100.f,           2.f,           false,      1000,           FSB_RoleMask::FSB_ROLEMASK_ANY },
...
namespace FSBRogue
{
    bool BotOOCBuffSelf(Creature* bot, uint32& outSpellId)
    {
        ...
        bool nonlethalPoison = bot->HasAura(SPELL_ROGUE_CRIPPLING_POISON);
        ...
        {
            uint32 spellId = SPELL_ROGUE_CRIPPLING_POISON;
            bot->CastSpell(bot, spellId, false);
            //buffTimer = now + 60000; // 1 minute
            cooldown = now + 1500; // 
            outSpellId = spellId;
