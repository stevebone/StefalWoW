...
enum FSB_SHAMAN_ELEMENTAL_SPELLS
{
    ...
    SPELL_SHAMAN_EARTHQUAKE = 61882, //GROUND TARGET AoE, 40f, 6s
...
enum FSB_SHAMAN_ENHANCEMENT_SPELLS
{
    ...
    SPELL_SHAMAN_FERAL_SPIRIT = 51533, //summon, 2m
...
enum FSB_SHAMAN_RESTO_SPELLS
{
    ...
    SPELL_SHAMAN_SPIRIT_LINK_TOTEM = 98008, //totem GROUND TARGET, 3m
