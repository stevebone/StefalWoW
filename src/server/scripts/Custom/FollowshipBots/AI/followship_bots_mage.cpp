...
std::vector<FSBSpellDefinition> MageSpellsTable =
{
    ...
    { SPELL_MAGE_CONE_OF_COLD, FSBSpellType::Damage,            0.08f,      0.f,            70.f,           6.f,           false,       25000,          FSB_RoleMask::FSB_ROLEMASK_ANY },
    ...
    { SPELL_MAGE_PYROBLAST,    FSBSpellType::Damage,            0.f,        0.f,            20.f,           40.f,          false,       1000,          FSB_RoleMask::FSB_ROLEMASK_RANGED_FIRE },
    { SPELL_MAGE_METEOR,       FSBSpellType::Damage,            0.f,        0.2f,           10.f,           40.f,          false,       45000,          FSB_RoleMask::FSB_ROLEMASK_RANGED_FIRE },
