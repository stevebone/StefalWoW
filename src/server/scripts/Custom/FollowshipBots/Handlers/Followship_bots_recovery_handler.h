...
struct BotRecoveryAction
{
    ...
    uint8 priority; // higher = preferred
...
struct ActionDrinkMana : BotRecoveryAction
{
    ...
    void Execute(Creature* bot, uint32& _globalCooldownUntil) override
    {
        ...
        bot->Say("I'm gonna take a mana break!", LANG_UNIVERSAL); // TO-DO maybe turn this into a choice of lines
    }
};
...
struct ActionHumanRecuperate : BotRecoveryAction
{
    ...
    void Execute(Creature* bot, uint32& _globalCooldownUntil) override
    {
        ...
        bot->Say("I need a breather!", LANG_UNIVERSAL); // TO-DO maybe turn this into a choice of lines
    }
};
