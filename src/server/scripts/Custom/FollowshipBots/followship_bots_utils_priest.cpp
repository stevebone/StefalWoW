...
std::vector<FSBSpellCandidate> PriestSpellsTable =
{
    ...
    { SPELL_PRIEST_HEAL,                FSBSpellType::Heal,     90.f,       30.f,           80.f,           40.f,           false,      1000,           FSB_RoleMask::FSB_ROLEMASK_HEALER },
    ...
    { SPELL_PRIEST_RENEW,               FSBSpellType::Heal,     60.f,       80.f,           60.f,           40.f,           false,      1000,           FSB_RoleMask::FSB_ROLEMASK_ANY    },
    { SPELL_PRIEST_PURIFY,              FSBSpellType::Heal,     100.f,      0.f,            70.f,           40.f,           false,      8000,           FSB_RoleMask::FSB_ROLEMASK_HEALER },
    { SPELL_PRIEST_PSYCHIC_SCREAM,      FSBSpellType::Damage,   100.f,      0.f,            80.f,           8.f,            true,       45000,          FSB_RoleMask::FSB_ROLEMASK_ANY    },
    { SPELL_PRIEST_SHADOW_WORD_PAIN,    FSBSpellType::Damage,   90.f,       0.f,            80.f,           30.f,           false,      15000,          FSB_RoleMask::FSB_ROLEMASK_ANY    },
    { SPELL_PRIEST_VAMPIRIC_TOUCH,      FSBSpellType::Damage,   90.f,       0.f,            80.f,           30.f,           false,      15000,          FSB_RoleMask::FSB_ROLEMASK_DAMAGE },
    { SPELL_PRIEST_MIND_BLAST,          FSBSpellType::Damage,   80.f,       0.f,            70.f,           30.f,           false,      9000,           FSB_RoleMask::FSB_ROLEMASK_DAMAGE },
    ...
    { SPELL_PRIEST_DEVOURING_PLAGUE,    FSBSpellType::Damage,   50.f,       0.f,            40.f,           40.f,           false,      10000,          FSB_RoleMask::FSB_ROLEMASK_DAMAGE },
    { SPELL_PRIEST_MIND_FLAY,           FSBSpellType::Damage,   40.f,       0.f,            30.f,           35.f,           false,      1000,           FSB_RoleMask::FSB_ROLEMASK_DAMAGE },
