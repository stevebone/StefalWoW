...
public:
    ...
    std::span<ChatCommandBuilder const> GetCommands() const override
    {
        static ChatCommandTable fixTable = {
            {"faction",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixFaction,    "<factionId>"},
            {"friendly",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixFriendly,   ""},
            {"hostile",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixHostile,    ""},
            {"walk",       rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixWalk,       ""},
            {"fly",        rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixFly,        ""},
            {"delete",     rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixDelete,     ""},
            {"queststart", rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixQuestStart, "<questId>"},
            {"ct",         rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixContentTuning, "<ContentTuningId> [rowIndex]"},
            {"hp",         rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixHealth,        "<HealthModifier>"},
            {"diff",       rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixDifficulty,    "<DifficultyID> [<DifficultyID>...]"},
            {"diff1",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixDifficulty1,   "<DifficultyID>"},
            {"diff2",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixDifficulty2,   "<DifficultyID>"},
            {"diff3",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixDifficulty3,   "<DifficultyID>"},
            {"diff4",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixDifficulty4,   "<DifficultyID>"},
            {"diff5",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixDifficulty5,   "<DifficultyID>"},
            {"eflag",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixFlagsExtra,    "<flags_extra>"},
            {"npcinfo",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixNpcInfo,       ""},
            {"questinfo",  rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixQuestInfo,     "<questId>"},
            {"spellgcd",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixSpellGCD,      "<SpellID> [seconds]"},
            {"spellcd",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixSpellCD,       "<SpellID> <seconds>"},
            {"gstate",     rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGState,        "<StandState>"},
            {"cstate",     rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixCState,        "<StandState>"},
            {"gdead",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGDead,         ""},
            {"cdead",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixCDead,         ""},
            {"gnpcflag",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGNpcFlag,      "<npcflag>"},
            {"cnpcflag",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixCNpcFlag,      "<npcflag>"},
            {"guflags",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGUnitFlags,    "<unit_flags>"},
            {"cuflags",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixCUnitFlags,    "<unit_flags>"},
            {"guflags2",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGUnitFlags2,   "<unit_flags2>"},
            {"cuflags2",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixCUnitFlags2,   "<unit_flags2>"},
            {"guflags3",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGUnitFlags3,   "<unit_flags3>"},
            {"cuflags3",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixCUnitFlags3,   "<unit_flags3>"},
            {"combat",     rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixCombat,        ""},
            {"questprev",  rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixQuestPrev,    "<questId> <prevQuestId>"},
            {"addnpc",     rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixAddNpc,       ""},
            {"gmove",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGMove,        "<MovementType>"},
            {"cmove",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixCMove,        "<MovementType>"},
            {"gmoverange", rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGMoveRange,   "<wander_distance>"},
            {"scalesize",  rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixScaleSize,     "<scale>"},
            {"gmoveall",   rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGMoveAll,      "[movementType] [wander_distance]"},
            {"gpos",       rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGPos,         ""},
            {"gemote",     rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGEmote,       "<emoteId>"},
            {"emote",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixEmote,        "<emoteId>"},
            {"gauras",     rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixGAuras,       "<spellId> [<spellId>...]"},
            {"smart",      rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixSmart,        ""},
            {"unsmart",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixUnsmart,      ""},
            {"wayinfo",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixWayInfo,      ""},
            {"wayadd",     rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixWayAdd,       ""},
            {"waynode",    rbac::RBAC_PERM_COMMAND_GM, false, &HandleFixWayNode,      ""},
        };
